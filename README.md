...
In this repo you'll find the first capstone project I worked on for the full stack coding bootcamp
Tech Elevator. It's a relatively simple pure Java application. Working pair programming style
with a partner, we were tasked with building a vending machine application and a CLI.

It was good exercise in proving that we understood the basics of Java and OOP. Additionally,
working closely with a partner pair programming style taught us how to collaborate on a project.
This project is probably a very rare instance of using Java's built in functions to read/write to plain text files -
not something you'd generally want to do in a real world application.

As with all my capstone projects, I'll be aiming to go back through these projects and identify
opportunities to make them more readable, fix any bugs, or refactor anything that seems ineffiecent.
Check out different branches of these repos to see the old version I submitted to Tech Elevator
and newer branches where I've made improvements. If you don't see a new branch, I just haven't had time yet.

Huge thanks to my pair programming partner on this project, Sarab Bains, for being an excellent programmer to collaborate with!

Below is Tech Elevator's Readme for the project which describes the expected requirements.
